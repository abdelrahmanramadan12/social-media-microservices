...
namespace Service.Interfaces.ProfileServices
{
    public interface IProfileService
    {
        ...
        Task<ResponseWrapper<SimpleUserProfile>> GetByUserNameMinAsync(string userName);
        Task<ResponseWrapper<List<SimpleUserProfile>>> GetUsersByIdsAsync(List<string> userIds);
