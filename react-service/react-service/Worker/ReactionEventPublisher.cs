...
namespace Workers
{
    public class ReactionEventPublisher : IQueuePublisher<ReactionEvent>
    {
        ...
        public ReactionEventPublisher(IConfiguration configuration)
        {
            ...
            _queueNames = configuration.GetSection("RabbitQueues:ReactionQueue").GetChildren().Select(c => c.Value).ToList()!;
