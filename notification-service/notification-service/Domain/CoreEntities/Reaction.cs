...
namespace Domain.CoreEntities
{
    public class Reaction
    {
        ...
        public List<string> ReactionsOnMessageId { get; set; } = [];
        ...
        public List<string> MessageReactionsNotifReadByAuthor { get; set; } = []; // List of reaction items, each containing user ID and reaction type
    }
}
